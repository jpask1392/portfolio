    ...
    <Layout global={global} preview={preview}>
      ...
      <Container>
        <div className="flex flex-wrap -mx-5 items-start">
          <div className={cn("absolute lg:sticky top-28 xl:top-36 bg-black", {
            "lg:w-4/12 xl:w-3/12 hidden lg:block w-full px-5" : showFilters,
            "sr-only" : !showFilters,
          })}>
            <CollectionSubheader 
          ...
          <div className={cn("px-5 mx-auto", {
            "w-full" : !showFilters,
            "w-full lg:w-8/12 xl:w-9/12" : showFilters,
          })}>
            <div className="relative">
              <div className="flex justify-end space-x-10 text-sm mb-10 m:mb-0 md:absolute top-0 right-0 z-10">
                ...
                >
                  <span><span className="hidden lg:inline">{showFilters ? "Hide" : "Show"}</span> Filters</span>
                  <DynamicIcon type="list"/>
                </button>
              ...
              <CollectionSubheader 
                collection={collection}
                visuallyHide={showFilters} 
              />
            </div>
            <div className={cn("grid gap-6 lg:gap-10", {
              "grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3" : showFilters,
              "grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4" : !showFilters,
              "opacity-25" : loading,
            })}>
              {
